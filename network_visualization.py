...
Original file is located at
    https://colab.research.google.com/drive/1HcqFCDFG3ICPjJ0eyGtuGHWvvYu7H1bD
"""
...
**Your Answer:** update image 하려면 (3, H, W)처럼 3차원의 형이어야 하는데 saliency map은 세 개의 channel 중 maximum(절댓값의)만을 가져와서 2차원임
