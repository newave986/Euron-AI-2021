...
Original file is located at
    https://colab.research.google.com/drive/1fgADPW1niebJBdjiBUbioD8t4XCUozVP
"""
...
fc_w_1 = random_weight((channel_2*32*32, 200))
fc_w_2 = random_weight((200, 10))
fc_b_2 = zero_weight((10,))
...
model = ThreeLayerConvNet(3 * 32 * 32, channel_1,channel_2 , 10)
optimizer = optim.SGD(model.parameters(), lr=learning_rate)
...
model = nn.Sequential(
    Flatten(),
    nn.Linear(3 * 32 * 32, channel_1),
    nn.LeakyReLU(0.01),
    nn.Linear(channel_1, channel_2),
    nn.Linear(channel_2, 10),
)
